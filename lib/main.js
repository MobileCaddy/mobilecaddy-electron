...
console.log("launcherHTMLPath", launcherHTMLPath);
...
function smartstoreUpsertSoupEntries(args, success) {
  // console.log("smartstoreUpsertSoupEntries2", args.table, args.entries.length);
  ...
  doUpdateEntries(args.table, args.externalIdPath, keyValues, upsertSqls).then(function(upRows){
    // console.log("smartstoreUpsertSoupEntries2 upRows", upRows.length);
    resultRows = upRows;
