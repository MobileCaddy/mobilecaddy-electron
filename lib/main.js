...
function createWindow () {
  ...
  storage.has('alreadyLoggedIn', function(error, hasKey) {
    ...
    if (hasKey) {
      ...
      var authUrl = pjson.loginEndpoint + '/services/oauth2/authorize?client_id=' + pjson.privConfig.salesforce_consumer_key + '&redirect_uri=' + 'testsfdc:///mobilesdk/detect/oauth/done' + '&response_type=token';
